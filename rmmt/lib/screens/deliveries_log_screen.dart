// lib/screens/deliveries_log_screen.dart
...
class DeliveriesLogScreen extends StatefulWidget {
  const DeliveriesLogScreen({super.key});

  @override
  State<DeliveriesLogScreen> createState() => _DeliveriesLogScreenState();
}

class _DeliveriesLogScreenState extends State<DeliveriesLogScreen> {
  ...
  void _showStatusEditor(int deliveryId, String currentStatus) {
    final auth = Provider.of<AuthProvider>(context, listen: false);
    if (!auth.isAdmin) return; // Only Admin can override status
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Deliveries Operations Log'),
        backgroundColor: kNavyMid,
        elevation: 0,
        actions: [
          IconButton(
              ...
              children: [
                Expanded(
                  child: DropdownButtonFormField<String?>(
                    ...
                    items: const [
                      DropdownMenuItem(value: null, child: Text('All Task Logs')),
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                ...
                                title: Text(
                                  'Task #${delivery['id']} - Sender: ${delivery['sender_name'] ?? 'User ${delivery['sender_id']}'}',
                                ...
                                subtitle: Column(
                                  ...
                                  children: [
                                    ...
                                    if (isExpanded) ...[
                                      ...
                                      _buildDetailRow('Sender name', '${delivery['sender_name'] ?? 'User ID ' + delivery['sender_id'].toString()}'),
                                        ...
                                        Align(
                                          ...
                                          child: TextButton.icon(
                                            style: TextButton.styleFrom(
                                              ...
                                              backgroundColor: kNavyDark.withOpacity(0.4),
                                            ),
                                            icon: const Icon(Icons.edit_road_rounded, size: 16),
                                            label: const Text('Manage Task Status', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                            onPressed: () => _showStatusEditor(deliveryId, status),
                                          ),
                                        ),
                                    ]
                                  ],
